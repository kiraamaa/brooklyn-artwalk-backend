...
ActiveRecord::Schema.define(version: 20170117154400) do
  ...
  add_index "points", ["artwalk_id"], name: "index_points_on_artwalk_id", using: :btree
  ...
  add_foreign_key "points", "artwalks"
end
